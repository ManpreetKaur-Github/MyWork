...
'CREATE TABLE ENTITY(
  ...
  ENT_CATEGORY_PRNT varchar2(25) NULL,      
  BATCH_ID Number NULL
  )';
END IF;
END;
...
--==========================================================
---CREATE ENT_EXPOSURE_SUPP table JIRA 80081
--============================================================
BEGIN
SELECT COUNT(*) INTO iExists FROM USER_OBJECTS WHERE OBJECT_TYPE='TABLE' AND OBJECT_NAME='ENT_EXPOSURE_SUPP';

IF iExists = 1 THEN
EXECUTE IMMEDIATE
 'DROP TABLE ENT_EXPOSURE_SUPP';
 iExists := 0 ;
END IF;
IF iExists = 0 THEN
EXECUTE IMMEDIATE
...
'CREATE TABLE UNIT_X_CLAIM(
  ...
  LIMITS varchar2(50) NULL, -- Newly Added - 23Jun2014 - Kapil
...
--==========================================================
---CREATE EMP_SUPP table 
--============================================================
BEGIN
SELECT COUNT(*) INTO iExists FROM USER_OBJECTS WHERE OBJECT_TYPE='TABLE' AND OBJECT_NAME='EMP_SUPP';
...
--==========================================================
---CREATE POLICY_SUPP table 
--============================================================
BEGIN
SELECT COUNT(*) INTO iExists FROM USER_OBJECTS WHERE OBJECT_TYPE='TABLE' AND OBJECT_NAME='POLICY_SUPP';

IF iExists = 1 THEN
EXECUTE IMMEDIATE
 'DROP TABLE POLICY_SUPP';
 iExists := 0 ;
END IF;
...
--==========================================================
---CREATE CVG_TYPE_SUPP table 
--============================================================
BEGIN
SELECT COUNT(*) INTO iExists FROM USER_OBJECTS WHERE OBJECT_TYPE='TABLE' AND OBJECT_NAME='CVG_TYPE_SUPP';

IF iExists = 1 THEN
EXECUTE IMMEDIATE
 'DROP TABLE CVG_TYPE_SUPP';
 iExists := 0 ;
END IF;
...
'CREATE TABLE RESERVES(
  ...
  CLAIMANT_LAST varchar2(255) NULL,
  CLAIMANT_FIRST varchar2(255) NULL,
...
'CREATE TABLE POLICY(
  ...
  PAID_TO_DATE varchar2(8) NULL, --mkaur24 HMI
  REINSURANCE_CODE varchar2(25) NULL,  -----mkaur24 HMI
  BATCH_ID Number NULL  
)';
END IF;
END;
...
CLIENT_SEQ_NUM varchar2 (30) NULL,
  BATCH_ID Number NULL,
  BIRTH_DATE varchar2(8) NULL, --mkaur24 HMI
  BENEFICIARY_CODE varchar2(25) NULL  -- mkaur24 HMI
)';
END IF;
END;
...
'CREATE TABLE PERSON_INVOLVED(
  ...
  DATE_OF_DEATH varchar2(8) NULL,
  REHAB_TEXT varchar2 (2000) NULL,
  DESC_BY_WITNESS varchar2 (2000) NULL,
  PATIENT_ACCT_NO varchar2(20) NULL,
  ...
  ADM_TYPE_CODE varchar2(25) NULL,
  ADM_SOURCE_CODE varchar2(25) NULL,
  ADMISSION_REASON varchar2 (2000) NULL,
  ACUITY_LEVEL_CODE varchar2(25) NULL,
  PATIENT_STAT_CODE varchar2(25) NULL,
  PATIENT_COND_CODE varchar2(25) NULL,
  DISCHARGE_DSP_CODE varchar2(25) NULL,
  ...
  HCO_ID_NO varchar2(20) NULL,
  HCO_SITE_ID_NO varchar2(20) NULL,
  WHY_AT_FACILITY varchar2 (2000) NULL,
  ...
  POLICY_ID number(10) NULL,
  CLIENT_SEQ_NUM varchar2 (30) NULL,
  PARENT_TABLE_NAME varchar2(30) NULL,
  BATCH_ID Number NULL,
    BENEFICIARY_CODE varchar2(25) NULL, --mkaur24 HMI
  BIRTH_DATE varchar2(8) NULL,
  EXTERNAL_ROLE varchar2(20) NULL,
  ADD_AS_CLAIMANT varchar2(1) NULL  --mkaur24 HMI 
...
IF iExists = 0 THEN
EXECUTE IMMEDIATE
'CREATE TABLE CLAIM_X_INSUREDUNIT (
    OPTIONSET_ID  number(10) NULL,
  CLAIM_ID  varchar2(50) NULL,
...
IF iExists = 0 THEN
EXECUTE IMMEDIATE
'CREATE TABLE FTS_X_REMARKS (
    OPTIONSET_ID number(10) NULL,
  SPLIT_ROW_ID number(10) NULL,
  EOB_REMARKS_CODE varchar2(25) NULL,
  BATCH_ID Number NULL
)';
END IF;
END;
...
'CREATE TABLE FUNDS (
  ...
  WEEKS_PAID_CODE varchar2(25) NULL,
  ...
  WITHHOLDING_TYPE varchar2(25) NULL,
  ...
  VOID_REASON_HTMLCOMMENTS varchar2(4000) NULL,
  EOB_PRINT_DATE varchar2(8) NULL,
  EOB_PRINTED_BY_USER varchar2(50) NULL,
  BEN_REVIEW_DATE varchar2(8) NULL,
  DSTRBN_TYPE_CODE varchar2(25) NULL,
  MAIL_TO_EID number(10) NULL,
  CLAIM_TO_BASE_CUR_RATE number(10,2) NULL,
    STOPPAY_REASON_CODE  varchar2(25) NULL,
    BATCH_ID Number NULL
)';
END IF;
END;
...
'CREATE TABLE FUNDS_TRANS_SPLIT (
  ...
  RESERVE_TYPE_CODE varchar2(25) NULL,
  AMOUNT number (10,2) NULL,
  GL_ACCOUNT_CODE varchar2(25) NULL,
...
EXECUTE IMMEDIATE 'CREATE TABLE SALVAGE(
  ...
  IS_INSURED varchar2(1)  NULL,
  IS_OWNER_RETAINED varchar2(1) NULL,
  ...
  THEFT_RECOVERED varchar2(1) NULL,
...
----- PS_ENDORSEMENT Table 06/08/2015
...
IF iExists = 0 THEN
EXECUTE IMMEDIATE 'CREATE TABLE PS_ENDORSEMENT(
  OPTIONSET_ID  number NULL,
...
IF iExists = 0 THEN
EXECUTE IMMEDIATE 'CREATE TABLE POLICY_X_STATE(
  OPTIONSET_ID number NULL,
  POLICY_ID number NULL,
  STATE_ID varchar2 (25) NULL,
  BATCH_ID Number NULL
...
'CREATE TABLE DIRECTORY (
  ...
  LAST_NAME_TEXT  varchar2 (255) NULL,
  FIRST_NAME_TEXT  varchar2 (255) NULL,
  ADDRESS_TEXT  varchar2(100) NULL,
...
--==========================================================
---CREATE IMPORT_AREAS_STRUCTURE table 
--============================================================

BEGIN
SELECT COUNT(*) INTO iExists FROM USER_OBJECTS WHERE OBJECT_TYPE='TABLE' AND OBJECT_NAME='IMPORT_AREAS_STRUCTURE';

IF iExists = 1 THEN
EXECUTE IMMEDIATE
 'DROP TABLE IMPORT_AREAS_STRUCTURE';
 iExists := 0 ;
END IF;

IF iExists = 0 THEN
EXECUTE IMMEDIATE
'CREATE TABLE IMPORT_AREAS_STRUCTURE(
  ROW_ID number(10) NULL,
  IMPORT_AREA varchar2(20) NULL,
  TABLES_NAME varchar2(4000) NULL,
  TABLE_STRUCTURE CLOB
)';
END IF;
END;

begin
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''1'''||','||'''Entities_Flag'''||','||'''ENTITY'''||','||'''CREATE TABLE ENTITY(
  OPTIONSET_ID number(10) NULL,
  BUSINESS_TYPE_CODE varchar2(25) NULL,
  COUNTY varchar2(30) NULL,
  NATURE_OF_BUSINESS varchar2(50) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''2'''||','||'''Entities_Flag'''||','||'''ENTITY_SUPP'''||','||'''CREATE TABLE ENTITY_SUPP(
  OPTIONSET_ID number NULL,
  ENTITY_ID number NULL

)'''||')';
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''3'''||','||'''Employees_Flag'''||','||'''ENTITY'''||','||'''CREATE TABLE ENTITY(
  OPTIONSET_ID number(10) NULL,
  BUSINESS_TYPE_CODE varchar2(25) NULL,
  COUNTY varchar2(30) NULL,
  NATURE_OF_BUSINESS varchar2(50) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''4'''||','||'''Employees_Flag'''||','||'''EMPLOYEE'''||','||'''CREATE TABLE EMPLOYEE(
  OPTIONSET_ID number(10) NULL,
  COUNTY_OF_RESIDNC varchar2(50) NULL,
  DRIVLIC_STATE varchar2(25) NULL,
  INSURABLE_FLAG varchar2(1) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''5'''||','||'''Employees_Flag'''||','||'''EMP_X_DEPENDENT'''||','||'''CREATE TABLE 
EMP_X_DEPENDENT(
  OPTIONSET_ID number(10) NULL,
  EMPLOYEE_EID number(10) NULL,  
  DEPENDENT_EID number(10) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''6'''||','||'''Employees_Flag'''||','||'''EMP_X_VIOLATION'''||','||'''CREATE TABLE 
EMP_X_VIOLATION(
  OPTIONSET_ID number(10) NULL,
  EMPLOYEE_EID number(10) NULL,
  VIOLATION_CODE varchar2(25) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''7'''||','||'''Employees_Flag'''||','||'''EMP_SUPP'''||','||'''CREATE TABLE EMP_SUPP(
  OPTIONSET_ID number(10) NULL,
  EMPLOYEE_EID number(10) NULL

)'''||')';
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''8'''||','||'''OrgExpo_Flag'''||','||'''ENTITY_EXPOSURE'''||','||'''CREATE TABLE 
ENTITY_EXPOSURE(
        OPTIONSET_ID number(10) NULL,
        EXPOSURE_ROW_ID number(10) NULL,
  ORG_TABLE_ID number(10) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''9'''||','||'''OrgHier_Flag'''||','||'''ENTITY'''||','||'''CREATE TABLE ENTITY(
 OPTIONSET_ID number(10) NULL,
  BUSINESS_TYPE_CODE varchar2(25) NULL,
  COUNTY varchar2(30) NULL,
  NATURE_OF_BUSINESS varchar2(50) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''10'''||','||'''OrgHier_Flag'''||','||'''ENTITY_SUPP'''||','||'''CREATE TABLE ENTITY_SUPP(
  OPTIONSET_ID number(10) NULL,
  ENTITY_ID number(10) NULL

)'''||')';
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''11'''||','||'''Funds_Flag'''||','||'''FUNDS'''||','||'''CREATE TABLE FUNDS(
    OPTIONSET_ID number (10) NULL,
  TRANS_ID number (10) NULL,
  VOID_DATE varchar2(8) NULL,
  AUTO_CHECK_FLAG number(10) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''12'''||','||'''Funds_Flag'''||','||'''FUNDS_TRANS_SPLIT'''||','||'''CREATE TABLE FUNDS_TRANS_SPLIT(
    OPTIONSET_ID number(10) NULL,
  SPLIT_ROW_ID number(10) NULL,
  TRANS_ID number(10) NULL,
  TRANS_TYPE_CODE varchar2(25) NULL,
  ...
  WITHHOLDING_SPLIT_FLAG number(10) NULL,
  CONTROL_REQ_FLAG number(10) NULL,
  FUNDS_CR_STATUS Varchar2(25) NULL,
  PMT_CURRENCY_AUTO_DISCOUNT number(10,2) NULL,
  CLAIM_CURRENCY_AUTO_DISCOUNT number(10,2) NULL,
  UPDATE_POL_SYS number(10) NULL,
  UNIT_TYPE varchar2(10) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''13'''||','||'''Funds_Flag'''||','||'''FUNDS_X_PAYEE'''||','||'''CREATE TABLE FUNDS_X_PAYEE(
  OPTIONSET_ID number NULL,
  PAYEE_EID number NULL,
  FUNDS_TRANS_ID number NULL,
  PAYEE_1099_FLAG number NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''14'''||','||'''Funds_Flag'''||','||'''ENTITY'''||','||'''CREATE TABLE ENTITY(
  OPTIONSET_ID number(10) NULL,
  BUSINESS_TYPE_CODE varchar2(25) NULL,
  COUNTY varchar2(30) NULL,
  NATURE_OF_BUSINESS varchar2(50) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''15'''||','||'''Funds_Flag'''||','||'''FUNDS_SUPP'''||','||'''CREATE TABLE FUNDS_SUPP(
  OPTIONSET_ID number(10) NULL,
  TRANS_ID number(10) NULL

)'''||')';
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''16'''||','||'''FundsDeposit_Flag'''||','||'''FUNDS_DEPOSIT'''||','||'''CREATE TABLE 
FUNDS_DEPOSIT(
  OPTIONSET_ID number NULL,
        DEPOSIT_ID number NULL,
  CTL_NUMBER varchar2(25) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''17'''||','||'''Vehicles_Flag'''||','||'''VEHICLE'''||','||'''CREATE TABLE VEHICLE(
  OPTIONSET_ID number NULL,
  DISPOSAL_DATE varchar2(8) NULL,
  LEASE_AMOUNT float NULL,
  LEASE_EXPIRE_DATE varchar2(8) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''18'''||','||'''Vehicles_Flag'''||','||'''VEHICLE_X_ACC_DATE'''||','||'''CREATE TABLE 
VEHICLE_X_ACC_DATE(
OPTIONSET_ID number NULL,
        UNIT_ID number NULL,
  ACCIDENT_DATE varchar2(8) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''19'''||','||'''Vehicles_Flag'''||','||'''VEHICLE_X_INSPCT'''||','||'''CREATE TABLE 
VEHICLE_X_INSPCT(
OPTIONSET_ID number NULL,
        UNIT_ID number NULL,
  INSPECTION_DATE varchar2(8) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''20'''||','||'''Vehicles_Flag'''||','||'''UNIT_X_CLAIM'''||','||'''CREATE TABLE UNIT_X_CLAIM(
  OPTIONSET_ID number NULL,
        UNIT_ID number NULL,
  CLAIM_ID varchar2(25) NULL,
  VEHICLE_MAKE varchar2(20) NULL,
  ...
  UNIT_TYPE_CODE varchar2(25) NULL,
  VIN varchar2(20) NULL,
  ISINSURED varchar2(2) NULL,
  ESTDAMAGE float NULL, 
  OWNER_LAST_NAME varchar2(255) NULL, 
  OWNER_FIRST_NAME varchar2(255) NULL, 
  OWNER_TAX_ID varchar2(20) NULL,
  ISDRIVABLE varchar2(2) NULL,
  ISNONVEHICLEPROPERTYDAMAGE varchar2(2) NULL, 
  OTHERINSURANCE varchar2(2) NULL,
  POLHOLDERISPROPERTYOWNER varchar2(2) NULL,
  POLICYHOLDER_LAST_NAME varchar2(255) NULL, 
  POLICYHOLDER_FIRST_NAME varchar2(255) NULL, 
  POLICYHOLDER_TAX_ID varchar2(20) NULL, 
  COMPANY_LAST_NAME varchar2(255) NULL, 
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''21'''||','||'''Vehicles_Flag'''||','||'''VEHICLE_SUPP'''||','||'''CREATE TABLE VEHICLE_SUPP(
OPTIONSET_ID number NULL,
  VIN_TEXT varchar2(255) NULL,
  SSN_TEXT varchar2(255) NULL,
  OP_LAST_TEXT varchar2(255) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''22'''||','||'''Policies_Flag'''||','||'''POLICY'''||','||'''CREATE TABLE POLICY(
    OPTIONSET_ID number(10) NULL,        
  ADDED_BY_USER varchar2(50) NULL,
  DTTM_RCD_ADDED varchar2(14) NULL,
  UPDATED_BY_USER varchar2(50) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''23'''||','||'''Policies_Flag'''||','||'''POLICY_X_CVG_TYPE'''||','||'''CREATE TABLE POLICY_X_CVG_TYPE(
    OPTIONSET_ID number(10) NULL,
         CLAIM_LIMIT number(8,2) NULL,
  NOTIFICATION_UID number(10) NULL,
  POLCVG_ROW_ID number(10) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''24'''||','||'''Policies_Flag'''||','||'''POLICY_X_INSURED'''||','||'''CREATE TABLE POLICY_X_INSURED(
    OPTIONSET_ID number(10) NULL,
        POLICY_ID number(10) NULL,
  INSURED_EID number(10) NULL,
  LAST_NAME varchar2(255) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''25'''||','||'''Policies_Flag'''||','||'''POLICY_X_INSURER'''||','||'''CREATE TABLE POLICY_X_INSURER(
    OPTIONSET_ID number(10) NULL,
        POLICY_ID number(10) NULL,
  INSURER_CODE number(10) NULL,
  RES_PERCENTAGE number(8,2) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''26'''||','||'''Policies_Flag'''||','||'''POINT_UNIT_DATA'''||','||'''CREATE TABLE POINT_UNIT_DATA(
    OPTIONSET_ID number(10) NULL,
  POLICY_ID number(10) NULL,
  UNIT_ID number(10) NULL,
  UNIT_TYPE varchar2(10) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''27'''||','||'''Policies_Flag'''||','||'''SITE_UNIT'''||','||'''CREATE TABLE SITE_UNIT(
    OPTIONSET_ID number(10) NULL,
  UNIT_ID number(10) NULL,
  SITE_NUMBER varchar2(50) NULL,
  NAME  varchar2(200) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''28'''||','||'''Policies_Flag'''||','||'''PROPERTY_UNIT'''||','||'''CREATE TABLE PROPERTY_UNIT(
    OPTIONSET_ID number(10) NULL,
  UNIT_ID number(10) NULL,
  PIN varchar2(255) NULL,
  DESCRIPTION varchar2(50) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''29'''||','||'''Policies_Flag'''||','||'''VEHICLE'''||','||'''CREATE TABLE VEHICLE(
  OPTIONSET_ID number NULL,
  DISPOSAL_DATE varchar2(8) NULL,
  LEASE_AMOUNT float NULL,
  LEASE_EXPIRE_DATE varchar2(8) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''30'''||','||'''Policies_Flag'''||','||'''UNIT_X_CLAIM'''||','||'''CREATE TABLE UNIT_X_CLAIM(
  OPTIONSET_ID number NULL,
  UNIT_ID number NULL,
  CLAIM_ID varchar2(25) NULL,
  VEHICLE_MAKE varchar2(20) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''31'''||','||'''Policies_Flag'''||','||'''CLAIM_X_PROPERTYLOSS'''||','||'''CREATE TABLE CLAIM_X_PROPERTYLOSS(
    OPTIONSET_ID  number(10) NULL,
  PROPERTY_ID  number(10) NULL,
  CLAIM_ID varchar2(25) NULL,
  INSURED varchar2(1) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''32'''||','||'''Policies_Flag'''||','||'''CLAIM_X_SITELOSS'''||','||'''CREATE TABLE CLAIM_X_SITELOSS(
    OPTIONSET_ID number(10) NULL,
  CLAIM_ID varchar2(25) NULL,
  SITE_ID number(10) NULL,
  LOSS_PREVENTION_REPRESENTATIVE varchar2(100) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''33'''||','||'''Policies_Flag'''||','||'''CLAIM_X_OTHERUNIT'''||','||'''CREATE TABLE CLAIM_X_OTHERUNIT(
    OPTIONSET_ID number(10) NULL,
  CLAIM_ID varchar2(25) NULL,
  OTHER_UNIT_ID number(10) NULL,
  UNIT_TYPE varchar2(10) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''34'''||','||'''Policies_Flag'''||','||'''DRIVER'''||','||'''CREATE TABLE DRIVER(
    OPTIONSET_ID number(10) NULL,
  DRIVER_ROW_ID number(10) NULL,  
  DRIVER_LAST_NAME varchar2(255) NULL,
  DRIVER_FIRST_NAME varchar2(255) NULL,  
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''35'''||','||'''Policies_Flag'''||','||'''OTHER_UNIT'''||','||'''CREATE TABLE OTHER_UNIT(
    OPTIONSET_ID number(10) NULL,
  OTHER_UNIT_ID number(10) NULL,
  ENTITY_ID number(10) NULL,
  UNIT_TYPE varchar2(10) NULL,  
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''37'''||','||'''Policies_Flag'''||','||'''ENTITY'''||','||'''CREATE TABLE ENTITY(
  OPTIONSET_ID number(10) NULL,
  BUSINESS_TYPE_CODE varchar2(25) NULL,
  COUNTY varchar2(30) NULL,
  NATURE_OF_BUSINESS varchar2(50) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''38'''||','||'''Policies_Flag'''||','||'''POLICY_SUPP'''||','||'''CREATE TABLE POLICY_SUPP(
  OPTIONSET_ID number(10) NULL,
  POLICY_ID number(10) NULL

)'''||')';
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''39'''||','||'''Reserves_Flag'''||','||'''RESERVES'''||','||'''CREATE TABLE RESERVES(
  OPTIONSET_ID number NULL,
    RESERVE_ID number NULL,
  CLAIM_ID varchar2(25) NULL,
  RESERVE_TYPE_CODE varchar2(25) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''40'''||','||'''Patients_Flag'''||','||'''PATIENT'''||','||'''CREATE TABLE PATIENT(
        OPTIONSET_ID number(10) NULL,
  PATIENT_ACCT_NO varchar2(20) NULL,
  MEDICAL_RCD_NO varchar2(20) NULL,
  LAST_NAME varchar2(255) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''41'''||','||'''Patients_Flag'''||','||'''PATIENT_PROCEDURE'''||','||'''CREATE TABLE 
PATIENT_PROCEDURE(
  OPTIONSET_ID number(10) NULL,
      PATIENT_ACCT_NO varchar2(20) NULL,
  PROCEDURE_CODE varchar2(25) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''42'''||','||'''Patients_Flag'''||','||'''PATIENT_ACT_TAKEN'''||','||'''CREATE TABLE 
PATIENT_ACT_TAKEN(
  OPTIONSET_ID number(10) NULL,
      PATIENT_ACCT_NO varchar2(20) NULL,
  ACTION_CODE varchar2(25) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''43'''||','||'''Patients_Flag'''||','||'''PATIENT_DRG_CODES'''||','||'''CREATE TABLE 
PATIENT_DRG_CODES(
  OPTIONSET_ID number(10) NULL,
      PATIENT_ACCT_NO varchar2(20) NULL,
  DRG_CODE varchar2(25) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''44'''||','||'''Patients_Flag'''||','||'''PATIENT_ATTN_PHYS'''||','||'''CREATE TABLE 
PATIENT_ATTN_PHYS(
  OPTIONSET_ID number(10) NULL,
      PATIENT_ACCT_NO varchar2(20) NULL,
  PHYS_LAST_NAME varchar2(255) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''45'''||','||'''Patients_Flag'''||','||'''PATIENT_DIAGNOSIS'''||','||'''CREATE TABLE 
PATIENT_DIAGNOSIS(
  OPTIONSET_ID number(10) NULL,
      PATIENT_ACCT_NO varchar2(20) NULL,
  DIAGNOSIS_CODE varchar2(25) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''46'''||','||'''Patients_Flag'''||','||'''PATIENT_SUPP'''||','||'''CREATE TABLE PATIENT_SUPP(
  OPTIONSET_ID number(10) NULL,
      PATIENT_ACCT_NO varchar2(20) NULL
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''68'''||','||'''Patients_Flag'''||','||'''PATIENT_PROC_SUPP'''||','||'''CREATE TABLE 
PATIENT_PROC_SUPP(
  OPTIONSET_ID number(10) NULL,
      PATIENT_ACCT_NO varchar2(20) NULL,
  PROCEDURE_CODE varchar2(25) NULL
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''69'''||','||'''Policies_Flag'''||','||'''CVG_TYPE_SUPP'''||','||'''CREATE TABLE 
CVG_TYPE_SUPP(
OPTIONSET_ID number(10) NULL,
  POLICY_ID number(10) NULL,
 POLCVG_ROW_ID number(10) NULL 
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''47'''||','||'''Physicians_Flag'''||','||'''PHYSICIAN'''||','||'''CREATE TABLE PHYSICIAN(
  OPTIONSET_ID number NULL,
  PHYSICIAN_NUMBER varchar2(50) NULL,
  MED_STAFF_NUMBER varchar2(50) NULL,
  INTERNAL_NUMBER varchar2(20) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''48'''||','||'''Physicians_Flag'''||','||'''PHYS_CERTS'''||','||'''CREATE TABLE PHYS_CERTS(
  OPTIONSET_ID NUMBER NULL,
        PHYSICIAN_NUMBER varchar2(50) NULL,
  NAME_CODE varchar2(25) NULL,
  STATUS_CODE varchar2(25) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''49'''||','||'''Physicians_Flag'''||','||'''PHYS_EDUCATION'''||','||'''CREATE TABLE 
PHYS_EDUCATION(
  OPTIONSET_ID number NULL,
        PHYSICIAN_NUMBER varchar2(50) NULL,
  EDUC_TYPE_CODE varchar2(25) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''50'''||','||'''Physicians_Flag'''||','||'''PHYS_PREV_HOSP'''||','||'''CREATE TABLE 
PHYS_PREV_HOSP(
  OPTIONSET_ID number NULL,
        PHYSICIAN_NUMBER varchar2(50) NULL,
  STATUS_CODE varchar2(25) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''51'''||','||'''Physicians_Flag'''||','||'''PHYS_PRIVS'''||','||'''CREATE TABLE PHYS_PRIVS(
  OPTIONSET_ID number NULL,
        PHYSICIAN_NUMBER varchar2(50) NULL,
  CATEGORY_CODE varchar2(25) NULL,
  TYPE_CODE varchar2(25) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''52'''||','||'''Physicians_Flag'''||','||'''PHYS_SUB_SPECIALTY'''||','||'''CREATE TABLE 
PHYS_SUB_SPECIALTY(
  OPTIONSET_ID number NULL,
        PHYSICIAN_NUMBER varchar2(50) NULL,
  SPECIALTY_CODE varchar2(25) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''53'''||','||'''Physicians_Flag'''||','||'''PHYS_SUPP'''||','||'''CREATE TABLE PHYS_SUPP(
  OPTIONSET_ID number NULL,
        PHYSICIAN_NUMBER varchar2(50) NULL
)'''||')';
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''54'''||','||'''MedicalStaff_Flag'''||','||'''MED_STAFF'''||','||'''CREATE TABLE MED_STAFF(
  OPTIONSET_ID number(10) NULL,
        MED_STAFF_NUMBER varchar2(50) NULL,
  LAST_NAME varchar2(255) NULL,
  FIRST_NAME varchar2(255) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''55'''||','||'''MedicalStaff_Flag'''||','||'''STAFF_CERTS'''||','||'''CREATE TABLE 
STAFF_CERTS(
  OPTIONSET_ID number(10) NULL,
  MED_STAFF_NUMBER varchar2(50) NULL,
  NAME_CODE varchar2(25) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''56'''||','||'''MedicalStaff_Flag'''||','||'''STAFF_PRIVS'''||','||'''CREATE TABLE 
STAFF_PRIVS(
  OPTIONSET_ID number(10) NULL,
  MED_STAFF_NUMBER varchar2(50) NULL,
  CATEGORY_CODE varchar2(25) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''57'''||','||'''MedicalStaff_Flag'''||','||'''MED_STAFF_SUPP'''||','||'''CREATE TABLE MED_STAFF_SUPP(
  OPTIONSET_ID number(10) NULL,
  MED_STAFF_NUMBER varchar2(50) NULL

)'''||')';
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''58'''||','||'''AdminTrack_Flag'''||','||'''PROP_MGT'''||','||'''CREATE TABLE PROP_MGT (
  OPTIONSET_ID number NULL,
  PROP_MGT_ID number  NULL,
  PROP_ID_TEXT varchar2(50) NULL,
  LOCATION_TXCD varchar2(2000) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''59'''||','||'''AdminTrack_Flag'''||','||'''PROJ_TRACK'''||','||'''CREATE TABLE PROJ_TRACK 
(
  OPTIONSET_ID number NULL,
  PROJ_TRACK_ID number NULL,
  ACT_TYPE_CODE  varchar2(25) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''60'''||','||'''AdminTrack_Flag'''||','||'''DIRECTORY'''||','||'''CREATE TABLE DIRECTORY (
  OPTIONSET_ID number NULL,
  DIRECTORY_ID number  NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''61'''||','||'''AdminTrack_Flag'''||','||'''COMPL_MGT'''||','||'''CREATE TABLE COMPL_MGT (
OPTIONSET_ID number NULL,
  COMPL_MGT_ID number  NULL,
  COMP_NO_TEXT  varchar2(25) NULL,
  DT_RECV_DATE  varchar2(8) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''62'''||','||'''AdminTrack_Flag'''||','||'''CONTRCT_MGT'''||','||'''CREATE TABLE 
CONTRCT_MGT (
OPTIONSET_ID number NULL,
  CONTRCT_MGT_ID number  NULL,
  CONT_TYPE_CODE varchar2(25)NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''63'''||','||'''AdminTrack_Flag'''||','||'''CERTIFICATE'''||','||'''CREATE TABLE 
CERTIFICATE (
OPTIONSET_ID  number NULL,
  CERTIFICATE_ID  number  NULL,
  JOB_NO_TEXT  varchar2(15) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''64'''||','||'''AdminTrack_Flag'''||','||'''BOND_ABS'''||','||'''CREATE TABLE BOND_ABS (
OPTIONSET_ID number NULL,
  BOND_ABS_ID number  NULL,
  BOND_NUM_TEXT  varchar2(20) NULL,
  BOND_TYPE_TXCD  varchar2(2000) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''65'''||','||'''Policies_Flag'''||','||'''PS_ENDORSEMENT'''||','||'''CREATE TABLE PS_ENDORSEMENT(
  OPTIONSET_ID  number NULL,
  ENDORSEMENT_ID  number NULL,
  POLICY_ID  number NULL,
  TABLE_NAME varchar2(30) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''66'''||','||'''Policies_Flag'''||','||'''SALVAGE'''||','||'''CREATE TABLE SALVAGE(
  OPTIONSET_ID number(10) NULL,
  UNIT_ID   number(10) NULL,
  SALVAGE_ROW_ID   number(10) NULL,
  PARENT_NAME varchar2(50) NULL,
...
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''67'''||','||'''Policies_Flag'''||','||'''POLICY_X_STATE'''||','||'''CREATE TABLE POLICY_X_STATE(
  OPTIONSET_ID number NULL,
  POLICY_ID number NULL,
  STATE_ID varchar2 (25) NULL,
  BATCH_ID Number NULL
...
EXECUTE IMMEDIATE  'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''36'''||','||'''Policies_Flag'''||','||'''PERSON_INVOLVED'''||','||':1'||')' using tbl_string;
END;
...
BEGIN 
tbl_string:= 'CREATE TABLE INSURED_UNIT(
   OPTIONSET_ID  number(10) NULL,
  POLICY_ID  number(10) NULL,
  ENTITY_ID  number(10) NULL,
  UNIT_ID  number(10) NULL,
...
EXECUTE IMMEDIATE  'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''70'''||','||'''Policies_Flag'''||','||'''INSURED_UNIT'''||','||':1'||')' using tbl_string;
END;

COMMIT;

BEGIN 
tbl_string:= 'CREATE TABLE COVERAGE_BENEFIT(
   OPTIONSET_ID  number(10) NULL,
   CVG_ROW_ID  number(10) NULL,
   BENEFIT_AMOUNT   float  NULL,
   BENEFIT_OPTION  varchar2(4) NULL,
...
EXECUTE IMMEDIATE  'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''70'''||','||'''Policies_Flag'''||','||'''COVERAGE_BENEFIT'''||','||':1'||')' using tbl_string;
END;
...
BEGIN 
tbl_string:= 'CREATE TABLE CLAIM_X_INSUREDUNIT(
     OPTIONSET_ID  number(10) NULL,
  CLAIM_ID  varchar2(50) NULL,
  INSURED_UNIT_ID  number(10) NULL,
  UNIT_TYPE  varchar2(10) NULL,
...
EXECUTE IMMEDIATE  'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''70'''||','||'''Policies_Flag'''||','||'''CLAIM_X_INSUREDUNIT'''||','||':1'||')' using tbl_string;
END;
...
BEGIN 
tbl_string:= 'CREATE TABLE POL_COV_LIMIT(
  OPTIONSET_ID Number NULL,
  LIMIT_ROW_ID Number null,       
  POLICY_KEY Number NULL,        
  COVERAGE_KEY Number NULL,      
...
EXECUTE IMMEDIATE  'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''70'''||','||'''Policies_Flag'''||','||'''POL_COV_LIMIT'''||','||':1'||')' using tbl_string;
END;

COMMIT;


EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''71'''||','||'''Funds_Flag'''||','||'''FTS_X_REMARKS'''||','||'''CREATE TABLE FTS_X_REMARKS(
  OPTIONSET_ID number(10) NULL,
  SPLIT_ROW_ID number(10) NULL,
  EOB_REMARKS_CODE varchar2(25) NULL,
  BATCH_ID Number NULL
...
--JIRA 80081 starts
BEGIN
tbl_string:= 'CREATE TABLE ENT_EXPOSURE_SUPP(
	OPTIONSET_ID number(10) NULL,
	EXPOSURE_ROW_ID number(10) NULL
	)';
EXECUTE IMMEDIATE 'INSERT into IMPORT_AREAS_STRUCTURE VALUES('||'''72'''||','||'''OrgExpo_Flag'''||','||'''ENT_EXPOSURE_SUPP'''||','||':1'||')' using tbl_string;
END;
COMMIT;
