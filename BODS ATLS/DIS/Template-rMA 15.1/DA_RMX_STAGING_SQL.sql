...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ENT_EXPOSURE_SUPP]') AND type in (N'U'))
DROP TABLE [dbo].[ENT_EXPOSURE_SUPP]
GO
...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[FUNDS_TRANS_SPLIT_SUPP]') AND type in (N'U'))
DROP TABLE [dbo].[FUNDS_TRANS_SPLIT_SUPP]
GO
...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PI_SUPP]') AND type in (N'U'))
DROP TABLE [dbo].[PI_SUPP]
GO
...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PI_X_WRKLOSS_SUPP]') AND type in (N'U'))
DROP TABLE [dbo].[PI_X_WRKLOSS_SUPP]
GO
...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[POLICY_SUPP]') AND type in (N'U'))
DROP TABLE [dbo].[POLICY_SUPP]
GO
...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[T_DIS_ENTITY_X_ADDRESSES]') AND type in (N'U'))
DROP TABLE [dbo].[T_DIS_ENTITY_X_ADDRESSES]
GO
...
BEGIN
	CREATE TABLE [dbo].[DIRECTORY](
		...
		[LAST_NAME_TEXT] [varchar](50) NULL,
		[FIRST_NAME_TEXT] [varchar](50) NULL,
...
BEGIN
	CREATE TABLE [dbo].[ENTITY](
		...
		[CONTACT_NAME] [varchar](50) NULL,           -- start kkaur25-14.2enhancements
...
IF NOT EXISTS (SELECT name FROM sys.tables WHERE name = 'ENT_EXPOSURE_SUPP') 
BEGIN
...
BEGIN
	CREATE TABLE [dbo].[ENTITY_SUPP](
		...
		[UPDATE_ROW] [int] NULL,
		[ENTITY_ID] [int] NULL,
		[INDEX_BUREAU_NUMB] [varchar](12) NULL,
		[STE_AGNT_BRU_IDNT] [varchar](12) NULL,
...
IF NOT EXISTS (SELECT name FROM sys.tables WHERE name = 'FUNDS_TRANS_SPLIT_SUPP') 
BEGIN
...
IF NOT EXISTS (SELECT name FROM sys.tables WHERE name = 'MED_STAFF_SUPP') 
BEGIN
...
IF NOT EXISTS (SELECT name FROM sys.tables WHERE name = 'PATIENT_PROC_SUPP') 
BEGIN
...
IF NOT EXISTS (SELECT name FROM sys.tables WHERE name = 'PATIENT_SUPP') 
BEGIN
...
IF NOT EXISTS (SELECT name FROM sys.tables WHERE name = 'PHYS_SUPP') 
BEGIN
...
IF NOT EXISTS (SELECT name FROM sys.tables WHERE name = 'PI_SUPP') 
BEGIN
...
IF NOT EXISTS (SELECT name FROM sys.tables WHERE name = 'PI_X_WRKLOSS_SUPP') 
BEGIN
...
IF NOT EXISTS (SELECT name FROM sys.tables WHERE name = 'POLICY_SUPP') 
BEGIN
...
IF NOT EXISTS (SELECT name FROM sys.tables WHERE name = 'UNIT_X_CLAIM_SUPP') 
BEGIN
	CREATE TABLE [dbo].[UNIT_X_CLAIM_SUPP](
		...
		[VEH_NUM] [varchar](100) NULL,
		[PLATE_NUM] [varchar](100) NULL,
		[STATE] [varchar](100) NULL,
		[REL_TO_INS] [varchar](100) NULL,
		[LICENSE_NUM] [varchar](100) NULL,
		[DRIVER_STATE] [varchar](100) NULL,
		[PURPOSE_OF_USE] [varchar](100) NULL,
		[HAD_PERMISSION] [int] NULL,
		[VEH_EST_AMT] [float] NULL,
		[WHERE_VEH] [varchar](100) NULL,
		[WHEN_VEH] [varchar](100) NULL,
		[OTH_VEH_INS] [varchar](100) NULL,
		[SAME_AS_OWNER] [int] NULL,
		[VEH_COLOR_TEXT] [varchar](8) NULL,
		[ACV_AMT] [float] NULL,
...
IF NOT EXISTS (SELECT name FROM sys.tables WHERE name = 'VEHICLE_SUPP') 
BEGIN
...
BEGIN
	...
	[CLAIMANT_FIRST] [varchar](50) NULL,
	[CLAIMANT_LAST] [varchar](50) NULL,
...
BEGIN
	CREATE TABLE [dbo].[T_DIS_PATIENT](
		...
		[PRI_PHYS_LAST_NAME] [varchar](50) NULL,
		[PRI_PHYS_FIRST_NAME] [varchar](50) NULL,
		[PRI_PHYS_TAX_ID] [varchar](50) NULL,
		[ADM_PHYS_LAST_NAME] [varchar](50) NULL,
		[ADM_PHYS_FIRST_NAME] [varchar](50) NULL,
...
BEGIN
	CREATE TABLE [dbo].[T_DIS_PATIENT_PROCEDURE](
		...
		[SURGEON_LAST_NAME] [varchar](50) NULL,
		[SURGEON_FIRST_NAME] [varchar](50) NULL,
		[SURGEON_TAX_ID] [varchar](50) NULL,
		[ANESTH_LAST_NAME] [varchar](50) NULL,
		[ANESTH_FIRST_NAME] [varchar](50) NULL,
...
BEGIN
	CREATE TABLE [dbo].[T_DIS_PHYSICIAN](
		...
		[PARENT_1099_LAST_NAME] [varchar](50) NULL,
...
BEGIN
	CREATE TABLE [dbo].[T_DIS_RESERVE_CURRENT](
		...
		[CLAIMANT_FIRST_NAME] [varchar](50) NULL,
		[CLAIMANT_LAST_NAME] [varchar](50) NULL,
		[LINE_OF_BUS_CODE] [int] NULL,
		[RESERVE_ID] [int] NULL,
...
BEGIN
	CREATE TABLE [dbo].[T_DIS_UNIT_X_CLAIM](
		...
		[ASSIGNADJ_LAST_NAME] [nvarchar](100) NULL, -- Newly Added - 23Jun2014 - Kapil  --
...
BEGIN
	CREATE TABLE [dbo].[EVENTS_INPUT](
		...
		[REPORTED_LAST_NAME] [varchar](50) NULL,
		[REPORTED_FIRST_NAME] [varchar](25) NULL,
		...
		[PHYSICIAN_LAST_NAME] [varchar](150) NULL,
		[PHYSICIAN_FIRST_NAME] [varchar](75) NULL,
		...
		[PI_MIDDLE_NAME] [varchar](25) NULL,
...
BEGIN
	CREATE TABLE [dbo].[CLAIM_X_SITELOSS](
		...
		[LOSS_PREVENTION_CONTACT_NAME] [varchar](100) NULL,
...
END 
IF NOT EXISTS (SELECT name FROM sys.tables WHERE name = 'CLAIM_X_PROPERTYLOSS_SUPP') 
BEGIN
    ...
    CREATE TABLE [dbo].[CLAIM_X_PROPERTYLOSS_SUPP](
		...
		[ROW_ID] [int]  NULL,
		[STAGING_ID] [int] NULL,
	 CONSTRAINT [PK_CLAIM_X_PROPERTYLOSS_SUPP] PRIMARY KEY CLUSTERED 
	(
		[DA_ROW_ID] ASC,
		[JOBID] ASC
	)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
...
BEGIN
	CREATE TABLE [dbo].[T_DIS_CLAIM_X_SITELOSS](
		...
		[DA_ROW_ID] [int] NOT NULL,
		[CLAIM_ID] [varchar](25)  NULL,
		[ASSIGNADJ_LAST_NAME] [varchar](100) NULL,
		[ASSIGNADJ_FIRST_NAME] [varchar](50) NULL,	
...
BEGIN
	CREATE TABLE [dbo].[T_DIS_CLAIM_X_PROPERTYLOSS](
		...
		[POLICYHOLDER_LAST_NAME] [varchar](100) NULL,
		[POLICYHOLDER_FIRST_NAME] [varchar](50) NULL,	
		[POLICYHOLDER_TAX_ID] [varchar](20) NULL,
		[COMPANY_LAST_NAME] [varchar](100) NULL,
		[COMPANY_FIRST_NAME] [varchar](50) NULL,	
...
BEGIN
	CREATE TABLE [dbo].[T_DIS_DRIVER](
		...
		[DA_ROW_ID] [int] NOT NULL,
		[CLAIM_ID] [varchar](25) NULL,
		[DRIVER_LAST_NAME] [varchar](100) NULL,
		[DRIVER_FIRST_NAME] [varchar](50) NULL,	
