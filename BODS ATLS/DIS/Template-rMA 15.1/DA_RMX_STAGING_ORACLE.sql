...
(
    ...
    POLICYHOLDER_LAST_NAME varchar2(50) NULL, -- Newly Added - 23Jun2014 - Kapil  --
...
EXECUTE IMMEDIATE
'ALTER TABLE VEHICLE_SUPP ADD CONSTRAINT PK_VEHICLE_SUPP PRIMARY KEY (DA_ROW_ID, JOBID)';
...
EXECUTE IMMEDIATE
'ALTER TABLE MED_STAFF_SUPP ADD CONSTRAINT PK_MED_STAFF_SUPP PRIMARY KEY (DA_ROW_ID, JOBID)';
...
EXECUTE IMMEDIATE
'ALTER TABLE PATIENT_SUPP ADD CONSTRAINT PK_PATIENT_SUPP PRIMARY KEY (DA_ROW_ID, JOBID)';
...
EXECUTE IMMEDIATE
'ALTER TABLE PATIENT_PROC_SUPP ADD CONSTRAINT PK_PATIENT_PROC_SUPP PRIMARY KEY (DA_ROW_ID, JOBID)';
...
IF iExists = 0 THEN
  ...
  CREATE TABLE T_DIS_RESERVE_CURRENT(
	...
	CLAIMANT_FIRST_NAME varchar2(50) NULL,
	CLAIMANT_LAST_NAME varchar2(50) NULL,
...
END IF;
IF iExists = 0 THEN
  EXECUTE IMMEDIATE 'CREATE TABLE UNIT_X_CLAIM_SUPP(
  ...
  EXECUTE IMMEDIATE 'ALTER TABLE UNIT_X_CLAIM_SUPP ADD CONSTRAINT PK_UNIT_X_CLAIM_SUPP PRIMARY KEY (JOBID,DA_ROW_ID)';
...
END IF;
IF iExists = 0 THEN
  EXECUTE IMMEDIATE 'CREATE TABLE CLAIM_X_PROPERTYLOSS_SUPP(
  ...
  EXECUTE IMMEDIATE 'ALTER TABLE CLAIM_X_PROPERTYLOSS_SUPP ADD CONSTRAINT PK_CLAIM_X_PROPERTYLOSS_SUPP PRIMARY KEY (JOBID,DA_ROW_ID)';
