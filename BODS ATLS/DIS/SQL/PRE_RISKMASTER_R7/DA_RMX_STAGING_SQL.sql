...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[USER_VERIFICATION_TABLE]') AND type in (N'U'))
DROP TABLE [dbo].[USER_VERIFICATION_TABLE]
GO
...
BEGIN
	CREATE TABLE [dbo].[EMPLOYEE](
		...
		[STAGING_ID] [int] NULL,			--vgupta20 --added
...
BEGIN
	CREATE TABLE [dbo].[FUNDS](
		...
		[NOTES_HTMLCOMMENTS] [varchar](8000) NULL,
...
BEGIN
	CREATE TABLE [dbo].[PATIENT_PROCEDURE](
		...
		[COMPLICATIONS] [varchar](8000) NULL,
...
BEGIN
	CREATE TABLE [dbo].[PERSON_INVOLVED](
		...
		[LAST_VERIFIED_DATE] [varchar](8) NULL,
		[NUM_OF_VIOLATIONS] [int] NULL,
		[OSHA_ACC_DESC] [varchar](120) NULL,
		...
		[JOB_CLASS_CODE] [int] NULL,
		[OTHER_TREATMENTS] [varchar](8000) NULL,
		[OTHER_MEDCOND] [varchar](8000) NULL,
...
BEGIN
	CREATE TABLE [dbo].[VEHICLE](
		...
		[TYPE_OF_SERVICE] [varchar](8000) NULL,
		[INSURANCE_COVERAGE] [varchar](8000) NULL,
		[DELETED_FLAG] [smallint] NULL,
...
END
   ...
   --  gmahajan2 11/29/2010 MITS 21311 START; required columns added to USER_DEF_RESERVE_MAP to resolve errors logged in DIS_EXE_ERROR_.txt
...
BEGIN
	CREATE TABLE [dbo].[T_DIS_POLICY](
		...
		[INSURER_EID] [varchar](50) NULL,
		[BROKER_EID] [varchar](50) NULL,
...
BEGIN
	CREATE TABLE [dbo].[T_DIS_POLICY_X_CVG_TYPE](
		...
		[DA_ROW_ID] [int] NOT NULL,
		[POLICY_ID] [varchar](50) NULL,
		[NEXT_POLICY_ID] [varchar](50) NULL,
...
END
   ...
   --  gmahajan2 11/29/2010 MITS 21311 START; columns added to user_verification table to resolve errors logged in DIS_EXE_ERROR_.txt

   --  ****************************************************************************
IF NOT EXISTS (SELECT name FROM sys.tables WHERE name = 'USER_VERIFICATION_TABLE') 
BEGIN
	CREATE TABLE [dbo].[USER_VERIFICATION_TABLE](
		[TABLE_ID] [int] NULL,          
                [JOBID] [int] NULL,
